...
import { Mail, Phone, Linkedin, Github, Code, MapPin, Calendar, Award, Briefcase, GraduationCap, Terminal, Lightbulb, ExternalLink, ChevronRight, Zap, Brain, Target, Cpu, Database, Shield, Wifi, Lock } from 'lucide-react';
